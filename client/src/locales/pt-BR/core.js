...
export default {
  ...
  translation: {
    common: {
      ...
      aboutPlanka_title: 'Sobre a Unique',
      ...
      passwordIsTooWeak: 'A senha é muito fraca, por favor escolha uma senha mais forte',
      phone: 'Telefone',
    ...
    action: {
      ...
      showOnlyUnread: 'Mostrar apenas itens não lidos',
      sortList_title: 'Ordenar lista',
      start: 'Iniciar',
      stop: 'Parar',
