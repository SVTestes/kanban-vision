...
export default {
  ...
  CARD_RECURRENCE_CREATE: 'CARD_RECURRENCE_CREATE',
  CARD_RECURRENCE_CREATE__SUCCESS: 'CARD_RECURRENCE_CREATE__SUCCESS',
  CARD_RECURRENCE_CREATE__FAILURE: 'CARD_RECURRENCE_CREATE__FAILURE',
  CARD_RECURRENCE_CREATE_HANDLE: 'CARD_RECURRENCE_CREATE_HANDLE',
  CARD_RECURRENCE_DELETE: 'CARD_RECURRENCE_DELETE',
  CARD_RECURRENCE_DELETE__SUCCESS: 'CARD_RECURRENCE_DELETE__SUCCESS',
  CARD_RECURRENCE_DELETE__FAILURE: 'CARD_RECURRENCE_DELETE__FAILURE',
  CARD_RECURRENCE_DELETE_HANDLE: 'CARD_RECURRENCE_DELETE_HANDLE',
